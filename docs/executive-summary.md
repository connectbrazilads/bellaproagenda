...
A plataforma é um SaaS vertical para operação de salões de beleza, desenhada para unificar agenda, atendimento, caixa, equipe, relacionamento com clientes e rotinas assistidas por IA em uma única aplicação.
...
- plano de controle super-admin para gestão da base instalada
...
- automação incremental sobre mensageria, lembretes e IA conversacional
...
2. worker dedicado para lembretes, campanhas e IA proativa
3. fila para mensageria e integrações
4. observabilidade e rate limiting
5. endurecimento de autenticação e secrets management
