...
Write-Host "1. Alterando autenticacao para trust..."
$hbaTrust = @'
...
'@
[System.IO.File]::WriteAllText($hbaPath, $hbaTrust, $utf8NoBOM)

Write-Host "2. Reiniciando PostgreSQL..."
Restart-Service "postgresql-x64-18" -Force
Start-Sleep -Seconds 4

Write-Host "3. Definindo senha..."
& "C:\Program Files\PostgreSQL\18\bin\psql.exe" -U postgres -c "ALTER USER postgres PASSWORD 'salao123';"

Write-Host "4. Revertendo autenticacao..."
$hbaOriginal = @'
# PostgreSQL Client Authentication Configuration File
# ===================================================
#
...
# directly connected to.
#
# METHOD can be "scram-sha-256", "reject", "md5", "password", "scram-sha-256",
# "gss", "sspi", "ident", "peer", "pam", "oauth", "ldap", "radius" or
# "cert".  Note that "password" sends passwords in clear text; "md5" or
...
'@
[System.IO.File]::WriteAllText($hbaPath, $hbaOriginal, $utf8NoBOM)

Write-Host "5. Reiniciando PostgreSQL novamente..."
Restart-Service "postgresql-x64-18" -Force
Start-Sleep -Seconds 3

Write-Host ""
Write-Host "Pronto! Senha 'salao123' definida com sucesso."
Write-Host "Agora rode no terminal normal:"
Write-Host "  cd 'C:\Projetos\salao de beleza\backend'"
